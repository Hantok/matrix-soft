...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        [self.productName setFrame:CGRectMake(10, 0, 142, 20)];
        ...
        self.productCount = [[UILabel alloc] initWithFrame:CGRectMake(197, 0, 15, 20)];
        [self.productCount setText:@"25"];
        [self.productCount setFont:[UIFont systemFontOfSize:13]];
        ...
        self.productPriceSum = [[UILabel alloc] initWithFrame:CGRectMake(222, 0, 40, 20)];
        [self.productPriceSum setText:@"214.20"];
        [self.productPriceSum setFont:[UIFont systemFontOfSize:13]];
        ...
        self.lineSeparator = [[UIImageView alloc] initWithFrame:CGRectMake(216, 0, 1, self.frame.size.height)];
